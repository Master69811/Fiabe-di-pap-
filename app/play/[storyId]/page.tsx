...
export default function PlayPage({ params }: PageProps) {
  ...
  // Schermata "pronto per iniziare" con selezione musica
    ...
    >
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <AnimatePresence mode="wait">
          {/* SCHERMATA SELEZIONE MUSICA + AVVIO */}
          {waitingForStart ? (
            <motion.div
              key="start"
            ...
            >
              {/* Copertina animata */}
              <motion.div
                className="text-9xl mx-auto w-fit"
              ...
              <div>
                <h2 className="text-3xl font-black mb-1" style={{ color: '#4c1d95' }}>
                  {story.title}
                </h2>
                {childName && (
                  <p className="text-lg" style={{ color: '#7c3aed' }}>
                    Una storia per {childName} 💛
                  </p>
                )}
              </div>
              ...
              <p className="text-xs" style={{ color: '#a78bfa' }}>
                La prima volta richiede circa 30–60 secondi.
              </p>
            </motion.div>
          ) : generatingAudio ? (
            /* SCHERMATA GENERAZIONE AUDIO */
            <motion.div
              key="loading"
            ...
            >
              ...
              <div className="space-y-1">
                ...
                {childName && (
                  <p style={{ color: '#7c3aed' }}>Per {childName} 💛</p>
                )}
              </div>
